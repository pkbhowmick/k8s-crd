...
// StableV1alpha1Client is used to interact with features provided by the stable.example.com group.
type StableV1alpha1Client struct {
	restClient rest.Interface
}

func (c *StableV1alpha1Client) KubeApis(namespace string) KubeApiInterface {
	return newKubeApis(c, namespace)
}
